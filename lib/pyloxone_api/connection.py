...
class LoxoneBaseConnection:
    ...
    def __init__(
        ...
        *,
        ...
        token_safe_callback=Callable[[Any], Awaitable[None]],
    ):
        self.host = host
        ...
        self._token_safe_callback = token_safe_callback

    async def got_token(self):
        await self._token_safe_callback(self.get_token_dict())
